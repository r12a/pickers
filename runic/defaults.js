...
defaults.font = '"Junicode WF"'; // font name per usage in CSS
...
defaults.language = 'non'
defaults.blocklocation= '/scripts/runic/block'
defaults.uifont = '"Junicode WF"'; // font name per usage in CSS
