...
var factoryDefaults = new Object
	factoryDefaults.font = 'Noto Sans Armenian WF'; // text area font name (a single font, no quotes)
	...
	factoryDefaults.uifont = 'Noto Sans Armenian WF'; // font name  for selection area (a single font, no quotes)
