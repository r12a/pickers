...
<div id="contrastSwitch"  style="display:none" title="Change the contrast level." onclick="document.getElementById('access').style.display='flex'">
...
out += `
<div id="charChoice" style="display:none"></div>
...
`
if (show.default) out += `<div id="chardata" style="display:none;"><span id="charname">Type-assist (T) is on.</span></div>`
else out += `<div id="chardata" style="display:none;"><span id="charname">No type-assist available. Click on characters below.</span></div>`
