...
str = str.replace(/\u1BAB/g, "͓")
str = str.replace(/ᮀ/g, "ŋ̽")
...
str = str.replace(/ᮈ/g, "ə̣")
str = str.replace(/ᮉ/g, "ɤ̣")
str = str.replace(/ᮊ/g, "k")
str = str.replace(/ᮋ/g, "q")
str = str.replace(/ᮌ/g, "g")
str = str.replace(/ᮍ/g, "ŋ")
str = str.replace(/ᮎ/g, "ʧ")
str = str.replace(/ᮏ/g, "ʤ")
str = str.replace(/ᮐ/g, "z")
str = str.replace(/ᮑ/g, "ɲ")
...
str = str.replace(/ᮨ/g, "ə")
str = str.replace(/ᮩ/g, "ɤ")
str = str.replace(/᮪/g, "ˣ")
str = str.replace(/ᮬ/g, "m̆")
str = str.replace(/ᮭ/g, "w̆")
...
str = str.replace(/ᮺ/g, "")
str = str.replace(/ᮻ/g, "r̥")
str = str.replace(/ᮼ/g, "l̥")
str = str.replace(/ᮽ/g, "")
str = str.replace(/ᮾ/g, "k̽")
str = str.replace(/ᮿ/g, "m̽")
str = str.replace(/᳀/g, "")
str = str.replace(/᳁/g, "")
str = str.replace(/᳂/g, "")
str = str.replace(/᳃/g, "")
