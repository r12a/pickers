var defaults = {}
var factoryDefaults = {}
	factoryDefaults.font = 'Noto Serif Gurmukhi WF' // text area font name (a single font, no quotes)
	factoryDefaults.size = "36";  // text area font size, number of pixels (just the number)
	factoryDefaults.rows = "150"; // number representing number of times 100px for height of text area
	factoryDefaults.lineheight = "1.8"; // number representing line height of text area in pixels/100
	factoryDefaults.language = 'pa' // language to use for examples
	factoryDefaults.uifont = 'Noto Serif Gurmukhi WF'; // font name  for selection area (a single font, no quotes)
...
var webFonts = [ "Noto Serif Gurmukhi WF", "Noto Sans Gurmukhi WF" ]
