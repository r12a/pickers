...
var template = {}
	...
	template.sample = "دࣷومِ آدَمَ يࣺݒّ دَنُيْ جُدُّ، يَمْ ݖِ تَوفࣹيخْ ݖِ سَگْ اَکْ سَݧْ-سَݧْ. نࣹکّ نَ اِتْ کُ خَمْ دࣴگّ تࣹ اࣵندْ نَ خࣹلَمْ، تࣹ وَرْ نَا جࣴفْلَنْتࣹ اَکْ نَوْلࣹينْ، تࣹ تࣹگْ کࣷ ݖِ وࣵلُّ مبࣷکّ."
	template.sampleSource = ''
	template.blocklocation= 'arabic'  // block directory
	template.noteslocation = 'arab/wo' // location of script notes
	template.vocablocation = 'arab/wo_terms' // location of term database
