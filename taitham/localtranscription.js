...
str = str.replace(/ᩙ/g, "ṅ̽")
str = str.replace(/ᩘ/g, "ṉ̇̽")
str = str.replace(/ᩚ/g, "p̆")
str = str.replace(/ᩛ/g, "ᵽ")


// vocalics
str = str.replace(/ᩂ/g, "r̥ₔ")
str = str.replace(/ᩄ/g, "l̥ₔ")
