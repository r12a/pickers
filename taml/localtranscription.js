...
str = ' ' + transliterate(str).toUpperCase() + ' '

console.log(str)

// convert plosives according to context
str = str.replace(/([A|I|Ī|U|Ū|E|Ē|O|Ō|Ā])T͡Ʃ([A|I|Ī|U|Ū|E|Ē|O|Ō|Ā])/g,'$1s$2')
str = str.replace(/([A|I|Ī|U|Ū|E|Ē|O|Ō|Ā])Ʈ([A|I|Ī|U|Ū|E|Ē|O|Ō|Ā])/g,'$1ɽ$2')
str = str.replace(/([A|I|Ī|U|Ū|E|Ē|O|Ō|Ā])P([A|I|Ī|U|Ū|E|Ē|O|Ō|Ā])/g,'$1b$2')
str = str.replace(/([A|I|Ī|U|Ū|E|Ē|O|Ō|Ā])T([A|I|Ī|U|Ū|E|Ē|O|Ō|Ā])/g,'$1ð$2')
str = str.replace(/([A|I|Ī|U|Ū|E|Ē|O|Ō|Ā])K([A|I|Ī|U|Ū|E|Ē|O|Ō|Ā])/g,'$1g$2')

str = str.replace(/([M|Ṅ|N|ɳ|Ɲ|Ŋ]p[M|Ṅ|N|ɳ|Ɲ|Ŋ])\u0353T͡Ʃ/g, '$1dʑ$2')
str = str.replace(/([M|Ṅ|N|ɳ|Ɲ|Ŋ]p[M|Ṅ|N|ɳ|Ɲ|Ŋ])\u0353P/g, '$1b$2')
str = str.replace(/([M|Ṅ|N|ɳ|Ɲ|Ŋ]p[M|Ṅ|N|ɳ|Ɲ|Ŋ])\u0353T/g, '$1d$2')
str = str.replace(/([M|Ṅ|N|ɳ|Ɲ|Ŋ]p[M|Ṅ|N|ɳ|Ɲ|Ŋ])\u0353Ɽ/g, '$1ɖ$2')
str = str.replace(/([M|Ṅ|N|ɳ|Ɲ|Ŋ]p[M|Ṅ|N|ɳ|Ɲ|Ŋ])\u0353K/g, '$1g$2')
...
/*
function OLDtranscribeToIPA (str) {
