...
function setLangSwitch (node) {
	var labels = document.getElementById('langSwitch').querySelectorAll('span')
	for (i=0;i<labels.length;i++) {
		labels[i].classList.remove('shifted')
		if (labels[i] == node) labels[i].classList.add('shifted')
	}
}
