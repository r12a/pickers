...
var template = {}
	...
	template.blocklocation= 'armenian'  // block directory
	template.noteslocation = 'armenian/hy' // location of script notes
	template.vocablocation = 'armenian/hy_vocab' // location of term database
...
"desc":"Use ASCII characters to type Armenian from the keyboard using a customised key mapping.",
"dataShortTitle":"T", "type":"palette", "initialCode":"mapstring=makeTypeAssistMap(cols.key); setUpTypeAssist(false, mapstring, mapstring)", 
},

{"title":"Type assist: IPA to Armenian.", 
"desc":"Use an IPA keyboard mapping to type Armenian from the keyboard.",
"dataShortTitle":"æ", "type":"palette",
"initialCode":"mapstring=makeComplexTypeAssistMap(cols.ipaLoc);setUpTypeAssist(false, mapstring, mapstring)"
},

{"title":"Type assist: ISO 9985 transcription to Armenian.", 
"desc":"Use a  mapping from ISO to type Armenian from the keyboard.",
"dataShortTitle":"t", "type":"palette", "initialCode":"mapstring=makeComplexTypeAssistMap(cols.transcription);setUpTypeAssist(false, mapstring, mapstring)"
},

{"title":"Type assist: Map keys to an Armenian keyboard.", 
"desc":"Use a Armenian Armenian keyboard mapping to type from the keyboard.",
