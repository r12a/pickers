...
str = str.replace(/\u0F43/g, "gʰ")
str = str.replace(/\u0F4D/g, "ɖʰ")
str = str.replace(/\u0F52/g, "dʰ")
str = str.replace(/\u0F57/g, "bʰ")
str = str.replace(/\u0F5C/g, "ʣʰ")
str = str.replace(/\u0F69/g, "kˢ")
str = str.replace(/\u0F73/g, "ī")
str = str.replace(/\u0F75/g, "ū")
str = str.replace(/\u0F76/g, "r̥")
str = str.replace(/\u0F77/g, "r̥̄")
str = str.replace(/\u0F78/g, "l̥")
str = str.replace(/\u0F78/g, "l̥̄")
str = str.replace(/\u0F81/g, "ï̄")
str = str.replace(/\u0F93/g, "g̰ʰ")
str = str.replace(/\u0F9D/g, "ɖ̰ʰ")
str = str.replace(/\u0FA2/g, "d̰ʰ")
str = str.replace(/\u0FA7/g, "b̰ʰ")
str = str.replace(/\u0FAC/g, "ʣ̰ʰ")
str = str.replace(/\u0FB9/g, "k̰ˢ")
str = str.replace(/་/g, "␣")
str = str.replace(/༌/g, "༌")
str = str.replace(/།/g, "|")
str = str.replace(/༎/g, "‖")
...
str = str.replace(/ང/g, "ŋ")
str = str.replace(/ཅ/g, "ʧ")
str = str.replace(/ཆ/g, "ʧʰ")
str = str.replace(/ཇ/g, "ʤ")
str = str.replace(/ཉ/g, "ɲ")
str = str.replace(/ཊ/g, "ʈ")
str = str.replace(/ཋ/g, "ʈʰ")
str = str.replace(/ཌ/g, "ɖ")
str = str.replace(/ཎ/g, "ɳ")
...
str = str.replace(/ཾ/g, "m̽")
str = str.replace(/ཿ/g, "h̽")
str = str.replace(/ྀ/g, "ï")
str = str.replace(/ྃ/g, "m̽̇")
str = str.replace(/ྐ/g, "k̰")
str = str.replace(/ྑ/g, "k̰ʰ")
str = str.replace(/ྒ/g, "g̰")
str = str.replace(/ྔ/g, "ŋ̰")
str = str.replace(/ྕ/g, "ʧ̰")
str = str.replace(/ྖ/g, "ʧ̰ʰ")
str = str.replace(/ྗ/g, "ʤ̰")
str = str.replace(/ྙ/g, "ɲ̰")
str = str.replace(/ྚ/g, "ʈ̰")
str = str.replace(/ྛ/g, "ʈ̰ʰ")
str = str.replace(/ྜ/g, "ɖ̰")
str = str.replace(/ྞ/g, "ɳ̰")
str = str.replace(/ྟ/g, "t̰")
str = str.replace(/ྠ/g, "t̰ʰ")
str = str.replace(/ྡ/g, "d̰")
str = str.replace(/ྣ/g, "n̰")
str = str.replace(/ྤ/g, "p̰")
str = str.replace(/ྥ/g, "p̰ʰ")
str = str.replace(/ྦ/g, "b̰")
str = str.replace(/ྨ/g, "m̰")
str = str.replace(/ྩ/g, "ʦ̰")
str = str.replace(/ྪ/g, "ʦ̰ʰ")
str = str.replace(/ྫ/g, "ʣ̰")
str = str.replace(/ྭ/g, "w̰")
str = str.replace(/ྮ/g, "ʒ̰")
str = str.replace(/ྯ/g, "z̰")
str = str.replace(/ྰ/g, "à̰")
str = str.replace(/ྱ/g, "y̰")
str = str.replace(/ྲ/g, "r̰")
str = str.replace(/ླ/g, "l̰")
str = str.replace(/ྴ/g, "ʂ̰")
str = str.replace(/ྵ/g, "ʃ̰")
str = str.replace(/ྶ/g, "s̰")
str = str.replace(/ྷ/g, "h̰")
str = str.replace(/ྸ/g, "ạ̰")
str = str.replace(/ྺ/g, "w̰̄")
str = str.replace(/ྻ/g, "ȳ̰")
str = str.replace(/ྼ/g, "r̰̄")
str = str.replace(/༄/g, "ᵗ>")
str = str.replace(/༅/g, ">")
str = str.replace(/༈/g, "—")
str = str.replace(/༉/g, "•")
...
str = str.replace(/༼/g, "{")
str = str.replace(/༽/g, "}")
str = str.replace(/྄/g, "͓")
str = str.replace(/྅/g, "ː")
str = str.replace(/༹/g, "̣")
...
str = str.replace(/ྲཱྀ/g, "r̥̄")
str = str.replace(/ླཱྀ/g, "l̥̄")
str = str.replace(/ཀྵ/g, "kˢ")
str = str.replace(/གྷ/g, "gʰ")
str = str.replace(/ཌྷ/g, "ɖʰ")
str = str.replace(/དྷ/g, "dʰ")
str = str.replace(/བྷ/g, "bʰ")
str = str.replace(/ཛྷ/g, "ʣʰ")
str = str.replace(/ཱི/g, "ī")
str = str.replace(/ཱུ/g, "ū")
str = str.replace(/ཱྀ/g, "ï̄")
str = str.replace(/ྐྵ/g, "k̰ˢ")
str = str.replace(/ྒྷ/g, "g̰ʰ")
str = str.replace(/ྜྷ/g, "ɖ̰ʰ")
str = str.replace(/ྡྷ/g, "d̰ʰ")
str = str.replace(/ྦྷ/g, "b̰ʰ")
str = str.replace(/ྫྷ/g, "ʣ̰ʰ")
str = str.replace(/ྲྀ/g, "r̥")
str = str.replace(/ླྀ/g, "l̥")
str = str.replace(/ཕ༹/g, "f")
str = str.replace(/བ༹/g, "v")
