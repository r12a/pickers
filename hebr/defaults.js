...
var template = {}
	...
	template.blocklocation= 'hebrew'  // block directory
	template.noteslocation = 'hebrew/he' // location of script notes
	template.vocablocation = 'hebrew/he_vocab' // location of term database
...
"desc":"Use ASCII characters to type Hebrew from the keyboard using a customised key mapping.",
"dataShortTitle":"T", "type":"palette", "initialCode":"mapstring=makeTypeAssistMap(cols.key); setUpTypeAssist(false, mapstring, mapstring)", 
},

{"title":"Type assist: IPA to Hebrew.", 
"desc":"Use an IPA keyboard mapping to type Hebrew from the keyboard.",
"dataShortTitle":"æ", "type":"palette",
"initialCode":"mapstring=makeComplexTypeAssistMap(cols.ipaLoc);setUpTypeAssist(false, mapstring, mapstring)"
},

{"title":"Type assist: Academy transcription to Hebrew.", 
"desc":"Use a  mapping from the Academy transcription to type Hebrew from the keyboard.",
"dataShortTitle":"t", "type":"palette", "initialCode":"mapstring=makeComplexTypeAssistMap(cols.transcription);setUpTypeAssist(false, mapstring, mapstring)"
},

{"title":"Type assist: Map keys to a Hebrew keyboard.", 
"desc":"Use a Hebrew keyboard mapping to type from the keyboard.",
