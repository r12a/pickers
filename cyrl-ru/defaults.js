...
var template = {}
	...
	template.blocklocation= 'cyrillic'  // block directory
	template.noteslocation = 'cyrillic/ru' // location of script notes
	template.vocablocation = 'cyrillic/ru_vocab' // location of term database
...
"desc":"Use ASCII characters to type Russian from the keyboard using a customised key mapping.",
"dataShortTitle":"T", "type":"palette", "initialCode":"mapstring=makeTypeAssistMap(cols.key); setUpTypeAssist(false, mapstring, mapstring)", 
},

{"title":"Type assist: IPA to Russian.", 
"desc":"Use an IPA keyboard mapping to type Russian from the keyboard.",
"dataShortTitle":"æ", "type":"palette",
"initialCode":"mapstring=makeComplexTypeAssistMap(cols.ipaLoc);setUpTypeAssist(false, mapstring, mapstring)"
},

{"title":"Type assist: ISO transcription to Russian.", 
"desc":"Use a  mapping from ISO 9:1995 to type Russian from the keyboard.",
"dataShortTitle":"t", "type":"palette", "initialCode":"mapstring=makeComplexTypeAssistMap(cols.transcription);setUpTypeAssist(false, mapstring, mapstring)"
},

{"title":"Type assist: Map keys to an Russian keyboard.", 
"desc":"Use a standard Russian keyboard mapping to type from the keyboard.",
