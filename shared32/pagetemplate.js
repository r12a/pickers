...
// create the fontPickerCode which is used for the area above the text box
	...
	out += '</span> &nbsp;  &nbsp;  &nbsp; <a  class="fpOptgroup" href="../shared32/fontpreview.html" target="_blank">Usage tips</a>'
	out += '</div>'
	...
	for (let g=2;g<webfontGroups.length;g++) {
		...
		for (let o=0;o<options.length;o++) {
			...
			if (g===webfontGroups.length-1 && o===options.length-1) out += '<div class="fpOption"><a href="../shared32/fontpreview.html" onclick="document.getElementById(\'fontManagementDetails\').open=true; return false;">Add more</a></div>'
			}
		out += '</div>'
		}
...
<span class="touch" title="Tab" dir="auto" onClick="add('\u0009');"><img src="../images/tab.png" alt="⇥"`
...
<div><img src="../images/access.png" alt="Accessibility settings" onmouseover="showMenuText('Change the font size and the colours of the UI.','tan');" onmouseout="hideMenuText()"></div>
</div>
...
out += bp_appHeader('../../shared/images/world.gif',template.title.replace(/ Character app/i,'')+' workbench','v32');
...
<span id="tools">
<a class="interactiveHelpButton" style="margin-right:.5em;" href="../shared32/help.html#topRight" target="_help" title="Help for top level controls."><img alt="help" src="../images/help.png"/></a>
...
<a class="interactiveHelpButton" href="../shared32/help.html#exportPulldown" target="_help" title="Help with type-assist and other input aids."><img alt="help" src="../images/help.png"/></a>
...
<img title="Show notes about the first character in the selection." onclick="showNotes()" src="../images/notes.png" style="height:1.8rem;vertical-align: bottom;" alt="Notes" onmouseover="showMenuText(this.title,\'tan\');" onmouseout="hideMenuText()">`
...
<img title="Toggle invisible code points." onclick="toggleInvisibles()" src="../images/toggle.png" style="height:1.8rem;vertical-align: bottom;" alt="Toggle" onmouseover="showMenuText(this.title,\'tan\');" onmouseout="hideMenuText()">`
  ...
  out += `<img title="Delete all the text." onclick="deleteAll()" src="../images/clear.png" alt="Clear" style="margin-left: 1em;" onmouseover="showMenuText(this.title,\'tan\');" onmouseout="hideMenuText()">

<a class="interactiveHelpButton" href="../shared32/help.html#topLeftIcons" target="_help"><button title="Help with the icons."><img alt="help" src="../images/help.png"/></button></a>
  </span>
...
out += `
<button onclick="openEscapeWindow(); return false;" title="Convert to escapes." onMouseOver="showMenuText(this.title,'tan')" onMouseOut="hideMenuText()">Escape code converter</button>

<button onclick="openUniViewWindow(); return false;" title="Open in UniView." onMouseOver="showMenuText(this.title,'tan')" onMouseOut="hideMenuText()">UniView</button>

<button onclick="openUniViewUniqueWindow(); return false;" title="Show each unique character in UniView." onMouseOver="showMenuText(this.title,'tan')" onMouseOut="hideMenuText()">UniView (unique)</button>

<button onclick="openAnalyseWindow(); return false;" title="Open in Analyse String app." onMouseOver="showMenuText(this.title,'tan')" onMouseOut="hideMenuText()">Analyse String</button>

<button onclick="openListWindow(); return false;" title="Open in List Characters app." onMouseOver="showMenuText(this.title,'tan')" onMouseOut="hideMenuText()">List Characters</button>

<button onclick="openUsageWindow(); return false;" title="Open in Character Usage app." onMouseOver="showMenuText(this.title,'tan')" onMouseOut="hideMenuText()">Character Usage</button>

<button onclick="openFontlistWindow('`+template.scriptcode.toLowerCase()+`'); return false;" title="Open in Font Lister app." onMouseOver="showMenuText(this.title,'tan')" onMouseOut="hideMenuText()">Font Lister</button>

<button onclick="openListcatsWindow(); return false;" title="Open in List by category app." onMouseOver="showMenuText(this.title,'tan')" onMouseOut="hideMenuText()">General Category sorter</button>

<button onclick="openListbidiWindow(); return false;" title="Open in Triage Bidi app." onMouseOver="showMenuText(this.title,'tan')" onMouseOut="hideMenuText()">Bidi Class sorter</button>

<button onclick="openListlinebreakWindow(); return false;" title="Open in Triage for Linebreaking  app." onMouseOver="showMenuText(this.title,'tan')" onMouseOut="hideMenuText()">Line Break sorter</button>

<button onclick="openListindicWindow(); return false;" title="Open in Triage for Indic_Syllabic_Category app." onMouseOver="showMenuText(this.title,'tan')" onMouseOut="hideMenuText()">Indic Category sorter</button>

<button onclick="openGraphemeWindow(); return false;" title="Send to Grapheme Segmenter app." onMouseOver="showMenuText(this.title,'tan')" onMouseOut="hideMenuText()">Grapheme clusters</button>`

if (template.noteslocation) out += `
<button onclick="openScriptPageWindow(); return false;" title="View first character in selection in a page that describes the script." onMouseOver="showMenuText(this.title,'tan')" onMouseOut="hideMenuText()">Orthography notes</button>`
...
<button  id="countAll" type="button" onclick="if (document.getElementById('output').value== '') { alert('None.'); } else { count=[...document.getElementById('output').value]; alert(count.length+' characters.'); }" title="Count the characters in the text area." onMouseOver="showMenuText(this.title,'tan')" onMouseOut="hideMenuText()">Count characters</button>
...
<button  id="vocab2Markup" type="button" onclick="vocab2Markup(getHighlightedText(document.getElementById('output')))" title="Convert a vocab entry to example markup." onMouseOver="showMenuText(this.title,'tan')" onMouseOut="hideMenuText()">Convert term data to markup</button>
...
<a class="interactiveHelpButton" href="../shared32/help.html#manage_fonts" target="_help" title="Help with font management controls."><img alt="help" src="../images/help.png"/></a>
</div>
</details>
`
...
<a class="interactiveHelpButton" style="float:right; margin-right:.5em;" href="../shared32/help.html#autofocus" target="_help" title="Help with autofocus and direction."><img alt="help" src="../images/help.png"/></a>
</div>
`
*/
...
out += `
<div id="autofocusswitch">
<a class="interactiveHelpButton" style="margin-right:.5em;" href="../shared32/help.html#autofocus" target="_help" title="Help with autofocus and direction."><img alt="help" src="../images/help.png"/></a>
`

if (template.direction == "rtl" || template.direction == "bidi") {
    out += `
    <img title="Set base direction to LTR." onclick="document.getElementById('output').dir='ltr'; clearBidiOverride()" class="setDir" src="../images/arrows/ltr.png" alt=">" onmouseover="showMenuText(this.title,'tan');" onmouseout="hideMenuText()">
    <img title="Set base direction to Auto." onclick="document.getElementById('output').dir='auto'; clearBidiOverride()" class="setDir" src="../images/arrows/auto.png" alt="<>" onmouseover="showMenuText(this.title,'tan');" onmouseout="hideMenuText()">
    <img title="Set base direction to RTL." onclick="document.getElementById('output').dir='rtl'; clearBidiOverride()" class="setDir" src="../images/arrows/rtl.png" alt="<" onmouseover="showMenuText(this.title,'tan');" onmouseout="hideMenuText()">
    <img title="Set base direction to LTR override." onclick="document.getElementById('output').dir='ltr'; setBidiOverride('ltr',false)" class="setDir" src="../images/arrows/lro.png" alt=">>" onmouseover="showMenuText(this.title,'tan');" onmouseout="hideMenuText()">
    <img title="Set base direction to RTL override." onclick="document.getElementById('output').dir='rtl'; setBidiOverride('rtl',false)" class="setDir" src="../images/arrows/rlo.png" alt="<<" onmouseover="showMenuText(this.title,'tan');" onmouseout="hideMenuText()">
    `
    }
if (template.direction == "bidi") {
    out += `
    <img title="Set base direction to RTL override, and reverse character glyphs." onclick="document.getElementById('output').dir='ltr'; setBidiOverride('rtl',true)" class="setDir" src="../images/arrows/mirror.png" alt="<<<" onmouseover="showMenuText(this.title,'tan');" onmouseout="hideMenuText()">
    `
    }
...
<a class="interactiveHelpButton" href="../shared32/help.html#secondary_output" target="_help" style= "float: left; margin: 1em 1em 0 1em;" title="Help with the secondary text area."><img alt="help" src="../images/help.png"/></a>
...
function setInputAidMenu () {
	...
	out += `
	<span class="vmtab off"><a class="interactiveHelpButton" href="../shared32/help.html#inputAids" target="_help" title="Help with type-assist and other input aids."><img alt="help" src="../images/help.png"/></a></span>
    `
...
out = ''
	...
	<div class="vmtab off"><a class="interactiveHelpButton" href="../shared32/help.html#inputAids" target="_help" title="Help with type-assist and other input aids."><img alt="help" src="../images/help.png"/></a></div>
    `
...
out += `
<div><a class="interactiveHelpButton" href="../shared32/help.html#ktpHints" target="_help" title="Help with type-assist and other input aids."><img alt="help" src="../images/help.png"/></a></div>
</div>

<div style="position:relative"><div id="vtranscriptions"></div></div>
`
return out
}
...
out = `
  ...
  <div><a href="../shared32/help.html" target="_help">Get basic information</a> about how to use this app.</div>
...
<a class="interactiveHelpButton" href="../shared32/help.html#yellowControls" target="_help" title="Help with main yellow controls." style="margin: 1rem;"><img alt="help" src="../images/help.png"/></a>
...
out += `
<details>
    <summary style="margin-left:20px">more options</summary>
...
if (template.scriptcode) {
    ...
    if (template.noteslocation) out += '<a href="../../scripts/' + template.noteslocation + '.html" target="_blank">Orthography notes</a><br/>\n'
...
out += `<details style="margin-block-end:3rem;">
<summary>more character workbenches</summary>
<iframe id="pickerlist" src="../pickerlist.html?x=1"></iframe>
</details>
`
