...
// consonants
str = str.replace(/ꪁ/g, "k")
str = str.replace(/ꪀ/g, "ḵ")
str = str.replace(/ꪃ/g, "kʰ")
...
str = str.replace(/ꪖ/g, "ṯʰ")
str = str.replace(/ꪓ/g, "d")
str = str.replace(/ꪒ/g, "ḏ")
str = str.replace(/ꪙ/g, "n")
str = str.replace(/ꪘ/g, "ṉ")
str = str.replace(/ꪝ/g, "p")
str = str.replace(/ꪜ/g, "p̄")
str = str.replace(/ꪟ/g, "pʰ")
str = str.replace(/ꪞ/g, "p̄ʰ")
str = str.replace(/ꪛ/g, "b")
str = str.replace(/ꪚ/g, "ḇ")
str = str.replace(/ꪣ/g, "m")
str = str.replace(/ꪢ/g, "m̱")
str = str.replace(/ꪩ/g, "l")
str = str.replace(/ꪨ/g, "ḻ")
str = str.replace(/ꪧ/g, "r")
str = str.replace(/ꪦ/g, "ṟ")
str = str.replace(/ꪥ/g, "y")
str = str.replace(/ꪤ/g, "ȳ")
str = str.replace(/ꪫ/g, "w")
str = str.replace(/ꪪ/g, "w̱")
str = str.replace(/ꪭ/g, "h")
str = str.replace(/ꪬ/g, "ẖ")
str = str.replace(/ꪅ/g, "x")
str = str.replace(/ꪄ/g, "x̱")
str = str.replace(/ꪏ/g, "s")
...
// logographs
str = str.replace(/ꫛ/g, "kⁿ")
str = str.replace(/ꫜ/g, "nᵑ")
...
// vowel signs
str = str.replace(/ꪼ/g, "aʲ")
str = str.replace(/ꪻ/g, "əʷ")
str = str.replace(/ꪵ/g, "ɛ")
str = str.replace(/ꪹ/g, "ɨᵊ")
str = str.replace(/ꪶ/g, "o")

str = str.replace(/ꪰ/g, "a")
str = str.replace(/ꪱ/g, "ā")
str = str.replace(/ꪲ/g, "i")
str = str.replace(/ꪳ/g, "ɨ")
str = str.replace(/ꪴ/g, "u")
str = str.replace(/ꪷ/g, "ɔ")
str = str.replace(/ꪾ/g, "aᵐ")
str = str.replace(/ꪽ/g, "aⁿ")
str = str.replace(/ꪸ/g, "iᵊ")
str = str.replace(/ꪺ/g, "uᵊ")
