var defaults = {}
var factoryDefaults = {}
	factoryDefaults.font = 'Noto Sans Glagolitic WF' // text area font name (a single font, no quotes)
	factoryDefaults.size = "36";  // text area font size, number of pixels (just the number)
	factoryDefaults.rows = "150"; // px height of text area
	factoryDefaults.lineheight = "1.4"; // line height of text area
	factoryDefaults.language = 'cu' // language to use for examples
	factoryDefaults.uifont = 'Noto Sans Glagolitic WF'; // font name  for selection area (a single font, no quotes)
...
var thisPicker = 'glagoliticPicker'

if (localStorage.pickersStore && localStorage[thisPicker]) defaults = JSON.parse(localStorage[thisPicker]) 
else  defaults = factoryDefaults
 
var webFonts = [ "Noto Sans Glagolitic WF" ]
...
var template = {}
	...
	template.scriptcode = 'glag'
	template.fontLocale = "glag"
	template.hints = true
...
"desc":"Use ASCII characters to type Glagolitic from the keyboard using a customised key mapping.",
"dataShortTitle":"T", "type":"palette", "initialCode":"mapstring=makeTypeAssistMap(cols.key); setUpTypeAssist(false, mapstring, mapstring)", 
},

{"title":"Type assist: IPA to Glagolitic.", 
"desc":"Use an IPA keyboard mapping to type Glagolitic from the keyboard.",
