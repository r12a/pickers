...
str = str.replace(/ٔ/g, "‘")
str = str.replace(/ٖ/g, "ᵢ")
str = str.replace(/ٗ/g, "ᵘ")
str = str.replace(/٘/g, "ᵑ")
str = str.replace(/٪/g, "%")
str = str.replace(/ٰ/g, "ɑ̇")
str = str.replace(/ٹ/g, "ʈ")
str = str.replace(/پ/g, "p")
str = str.replace(/چ/g, "č")
str = str.replace(/ڈ/g, "ɖ")
str = str.replace(/ڑ/g, "ɽ")
str = str.replace(/ژ/g, "ʒ")
str = str.replace(/ک/g, "k")
str = str.replace(/گ/g, "g")
str = str.replace(/ں/g, "ñ")
str = str.replace(/ھ/g, "ʰ")
str = str.replace(/ۀ/g, "h͗")
str = str.replace(/ہ/g, "ḫ")
str = str.replace(/ۂ/g, "e͑")
str = str.replace(/ی/g, "y")
str = str.replace(/ے/g, "ɛ")
str = str.replace(/ۓ/g, "ɛ͑")
str = str.replace(/۔/g, ".")
str = str.replace(/۰/g, "0̣")
str = str.replace(/۱/g, "1̣")
str = str.replace(/۲/g, "2̣")
str = str.replace(/۳/g, "3̣")
str = str.replace(/۴/g, "4̣")
str = str.replace(/۵/g, "5̣")
str = str.replace(/۶/g, "6̣")
str = str.replace(/۷/g, "7̣")
str = str.replace(/۸/g, "8̣")
str = str.replace(/۹/g, "9̣")
