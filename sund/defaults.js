...
var template = {}
	...
	template.blocklocation= 'sundanese'  // block directory
	template.noteslocation = 'sundanese/su' // location of script notes
	template.vocablocation = 'sundanese/su_vocab' // location of term database
...
"desc":"Use ASCII characters to type Sundanese from the keyboard using a customised key mapping.",
"dataShortTitle":"T", "type":"palette", "initialCode":"mapstring=makeTypeAssistMap(cols.key); setUpTypeAssist(false, mapstring, mapstring)", 
},

{"title":"Type assist: IPA to Sundanese.", 
"desc":"Use an IPA keyboard mapping to type Sundanese from the keyboard.",
"dataShortTitle":"æ", "type":"palette",
"initialCode":"mapstring=makeComplexTypeAssistMap(cols.ipaLoc);setUpTypeAssist(false, mapstring, mapstring)"
},

{"title":"Type assist: Latin transcription to Sundanese.", 
"desc":"Use a  mapping from Latin to type Sundanese from the keyboard.",
"dataShortTitle":"t", "type":"palette", "initialCode":"mapstring=makeComplexTypeAssistMap(cols.transcription);setUpTypeAssist(false, mapstring, mapstring)"
},

{"title":"Type assist: Map keys to a Sundanese keyboard.", 
"desc":"Use a Sundanese keyboard mapping to type from the keyboard.",
