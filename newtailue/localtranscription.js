...
// vowel signs
str = str.replace(/ᦺ/g, "aʲ")
str = str.replace(/ᦵ/g, "e")
str = str.replace(/ᦶ/g, "ɛ̄")
str = str.replace(/ᦷ/g, "ō")

str = str.replace(/ᦰ/g, "’")
str = str.replace(/ᦱ/g, "a")
