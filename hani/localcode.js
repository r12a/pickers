...
function displayDBInfo (cp, block, lang, direction, showAll) { 
	...
	for (let i=0;i<chars.length;i++) {
		...
		if (han[chars[i]]) {
			...
			out += '<span class="dbCharSubContainer" style="display:flex;flex-direction:column;"><span class="dbCharInfo"><span><em>pinyin</em> '+han[chars[i]].m+'</span><span><em>def.</em>  <span class="ipa">'+han[chars[i]].def+'</span></span></span><span class="dbCharName">U+'+hex+': IDEOGRAPHIC CHARACTER</span></span></span>'
			}
