function localtranscribe (direction, str) {
	...
	if (direction == 'deva2gonm') { return deva2gonm(str) }
	}
...
function deva2gonm (str) {

str = ' '+str

str = str.replace(/र्/g, "𑵆")
str = str.replace(/ड़/g, "𑴦𑵂")
str = str.replace(/क्स/g, "𑴮")
str = str.replace(/त्र/g, "𑴰")
str = str.replace(/ज्ञ/g, "𑴯")
...
str = str.replace(/ँ/g, "𑵃")
str = str.replace(/ं/g, "𑵀")
str = str.replace(/ः/g, "𑵁")
str = str.replace(/्/g, "𑵅")

str = str.replace(/अ/g, "𑴀")
str = str.replace(/आ/g, "𑴁")
str = str.replace(/इ/g, "𑴂")
str = str.replace(/ई/g, "𑴃")
str = str.replace(/उ/g, "𑴄")
str = str.replace(/ऊ/g, "𑴅")
str = str.replace(/ऋ/g, "r̥̣")
str = str.replace(/ए/g, "𑴆")
str = str.replace(/ऐ/g, "𑴈")
str = str.replace(/ओ/g, "𑴉")
str = str.replace(/औ/g, "𑴋")

str = str.replace(/क/g, "𑴌")
str = str.replace(/ख/g, "𑴍")
str = str.replace(/ग/g, "𑴎")
str = str.replace(/घ/g, "𑴏")
str = str.replace(/ङ/g, "𑴐")
str = str.replace(/च/g, "𑴑")
str = str.replace(/छ/g, "𑴒")
str = str.replace(/ज/g, "𑴓")
str = str.replace(/झ/g, "𑴔")
str = str.replace(/ञ/g, "𑴕")
str = str.replace(/ट/g, "𑴖")
str = str.replace(/ठ/g, "𑴗")
str = str.replace(/ड/g, "𑴘")
str = str.replace(/ढ/g, "𑴙")
str = str.replace(/ण/g, "𑴚")
str = str.replace(/त/g, "𑴛")
str = str.replace(/थ/g, "𑴜")
str = str.replace(/द/g, "𑴝")
str = str.replace(/ध/g, "𑴞")
str = str.replace(/न/g, "𑴟")
str = str.replace(/प/g, "𑴠")
str = str.replace(/फ/g, "𑴡")
str = str.replace(/ब/g, "𑴢")
str = str.replace(/भ/g, "𑴣")
str = str.replace(/म/g, "𑴤")
str = str.replace(/य/g, "𑴥")
str = str.replace(/र/g, "𑴦")
str = str.replace(/ल/g, "𑴧")
str = str.replace(/ळ/g, "𑴭")
str = str.replace(/व/g, "𑴨")
str = str.replace(/श/g, "𑴩")
str = str.replace(/ष/g, "𑴪")
str = str.replace(/स/g, "𑴫")
str = str.replace(/ह/g, "𑴬")
str = str.replace(/़/g, "ˑ")
str = str.replace(/ऽ/g, "´")

str = str.replace(/ा/g, "𑴱")
str = str.replace(/ि/g, "𑴲")
str = str.replace(/ी/g, "𑴳")
str = str.replace(/ु/g, "𑴴")
str = str.replace(/ू/g, "𑴵")
str = str.replace(/ृ/g, "𑴶")
str = str.replace(/ॄ/g, "r̥̄")
str = str.replace(/े/g, "𑴺")
str = str.replace(/ै/g, "𑴼")
str = str.replace(/ो/g, "𑴽")
str = str.replace(/ौ/g, "𑴿")
str = str.replace(/्/g, "͓")
str = str.replace(/ॠ/g, "r̥̣̄")

str = str.replace(/।/g, ".")
str = str.replace(/॥/g, "¶")
str = str.replace(/०/g, "𑵐")
str = str.replace(/१/g, "𑵑")
str = str.replace(/२/g, "𑵒")
str = str.replace(/३/g, "𑵓")
str = str.replace(/४/g, "𑵔")
str = str.replace(/५/g, "𑵕")
str = str.replace(/६/g, "𑵖")
str = str.replace(/७/g, "𑵗")
str = str.replace(/८/g, "𑵘")
str = str.replace(/९/g, "𑵙")
str = str.replace(/॰/g, "¨")
str = str.replace(/₹/g, "¤")
str = str.replace(/\u200C/g, "ₓ")
str = str.replace(/\u200D/g, "₊")
