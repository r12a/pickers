...
var consonants = new Set(['ၵ', 'ၶ', 'ၷ', 'င', 'ၸ', 'သ', 'ၹ', 'ၺ', 'တ', 'ထ', 'ၻ', 'ၼ', 'ပ', 'ၽ', 'ၾ', 'ၿ', 'မ', 'ယ', 'ရ', 'လ', 'ဝ', 'ႀ', 'ႁ', 'ဢ', 'ျ', 'ြ', 'ႂ'])
var vowelSet = new Set(['ႃ', 'ၢ', 'ိ', 'ီ', 'ု', 'ူ', 'ေ', 'ဵ', 'ႄ', 'ႅ', 'ႆ', '႟', 'ွ'])
var medialSet = new Set([ 'ျ', 'ြ', 'ႂ'])
var finalSet = new Set([])
var nuktaSet = new Set([''])
var viramaSet = new Set(['\u1039', '\u103A'])
var combChar = new Set(['ႃ', 'ၢ', 'ိ', 'ီ', 'ု', 'ူ', 'ေ', 'ဵ', 'ႄ', 'ႅ', 'ႆ', '႟', 'ွ', 'ျ', 'ြ', 'ႂ', '\u1039', '\u103A'])
...
// vowel signs
str = str.replace(/ႃ/g, "ā")
str = str.replace(/ၢ/g, "ǟ")
str = str.replace(/ိ/g, "i")
str = str.replace(/ီ/g, "ī")
str = str.replace(/ု/g, "u")
str = str.replace(/ူ/g, "ū")
...
// digits
str = str.replace(/႐/g, "0")
str = str.replace(/႑/g, "1")
str = str.replace(/႒/g, "2")
str = str.replace(/႓/g, "3")
str = str.replace(/႔/g, "4")
str = str.replace(/႕/g, "5")
str = str.replace(/႖/g, "6")
str = str.replace(/႗/g, "7")
str = str.replace(/႘/g, "8")
str = str.replace(/႙/g, "9")
