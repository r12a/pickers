var plist = [
    ...
    { tag:'glag', name:'Gothic', url:'goth/index.html' },
    ...
    { tag:'latn', name:'Pan-African Latin', url:'latn-afr/index.html' },
    ...
    { tag:'tfng', name:'Neo-tifinagh', url:'tfng-ber/index.html' },
...
var plistByRegion = {
	...
	'P':[
			...
			['Pollard&nbsp;script', 'plrd-all/index.html'],
			],
	'R':[
